...
// // // import { displayName, initials, isConvertedStudent } from "@admin/lib/utils";
...
// // //       { to: "/unassigned", label: "Counselor Assign", icon: Target, end: false },
...
// // //       { to: "/applications", label: "Applications", icon: BookOpen, end: false },
// // //       { to: "/shortlists", label: "Shortlists", icon: University, end: false },
// // //       { to: "/chat", label: "Student Chat", icon: MessageCircle, end: false },
// // //       { to: "/ai-chat", label: "AI Chat", icon: MessagesSquare, end: false },
// // //     ],
// // //   },
// // //   {
// // //     title: "People",
...
// // //       { to: "/hr", label: "HR", icon: Wallet, end: false },
// // //     ],
// // //   },
// // //   {
// // //     title: "Catalog",
