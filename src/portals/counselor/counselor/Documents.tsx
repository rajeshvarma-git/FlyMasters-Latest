...
import { fetchDocumentFile, setDocumentStatus, useLocalStore } from "@counselor/lib/store";
      ...
      <div className="space-y-3">
        ...
        {filtered.length === 0 && (
          <Card className="p-12 text-center">
            ...
            {docs.length === 0 && (
              <Link to="/documents/setup" className="mt-4 inline-block">
                <Button>
