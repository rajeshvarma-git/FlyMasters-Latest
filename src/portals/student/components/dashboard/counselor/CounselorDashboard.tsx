...
import { LeadTimeline } from '@student/counselor/dashboard/LeadTimeline';
import { QuickActions } from '@student/counselor/dashboard/QuickActions';
...
import { ShiftTimer } from '@student/counselor/dashboard/ShiftTimer';
        ...
        <TabsContent value="dashboard" className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg p-6">
            ...
            <p className="text-muted-foreground mt-1">
              You have {urgentLeads.length} leads that need immediate attention today.
            </p>
          </div>
