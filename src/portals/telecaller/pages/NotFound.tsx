...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-navy-950 px-4 text-center text-white">
      ...
      <p className="mt-3 text-slate-300">That page is not in the telecaller site.</p>
      <Link to="/queue" className="mt-6 inline-block">
        <Button variant="gold">Back to my queue</Button>
      </Link>
    </div>
  );
}
